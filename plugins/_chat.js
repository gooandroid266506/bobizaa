let handler = m => m; 
 ...
   let responses; 
   if (/^ملاك بحبك|ملاك عاوزه اتجوزك|بحبك|بموت فيك|نتجوز|ملاك هنتجوز امتي|ملاك انت ليا|ملاك بموت فيكي$/i.test(m.text)) { 
     responses = [ 
       'شكرا  ',  
       'هفكر في الموضوع',  
             'و انا',  
 ...
     ]; 
   }else if (/^ ملاك عامل ايه|عامله ايه|عاملين ايه|الدنيا عامله ايه|عاملين ايه يشبب$/i.test(m.text)) { 
     responses = [ 
 ...
                             'دوم ' 
   ]; 
   }else if (/^ملاك|ملاك عمتك|يا ملاك$/i.test(m.text)) { 
     responses = [ 
       'قلب ملاك من جوا✨🥺♥',  
          ' ملاك عمك✨🤺 ',  
              ' قلب ملاك من جوا✨🥺♥',  
 ...
                   '✨💜' 
  ]; 
   }else if (/^اسكت|اسكت|هتسكت امتي|يا بنتي اسكت$/i.test(m.text)) { 
     responses = [ 
             'ملكش دعوه ', 
              ' لع وانت مالك',  
                 ' مش بمزاجك',  
